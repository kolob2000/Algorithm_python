...
class Tree:
    ...
    # функция создания таблицы символов, обычный рекурсивный обход дерева по всем ветвям.
    # при каждом вызове  функции, складывается код в зависимости от направления с бит направления
    # и передается как параметр вместе со следующем узлом. в случае если узел является листом рекурсия остонавливается
